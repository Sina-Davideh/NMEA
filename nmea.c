...
int main()
{
    ...
    // GSV_Structure_Update(&GPS_NMEA_DataPackage, GSV_Sample);
    // MSS_Structure_Update(&GPS_NMEA_DataPackage, MSS_Sample);
    // RMC_Structure_Update(&GPS_NMEA_DataPackage, RMC_Sample);
    // VTG_Structure_Update(&GPS_NMEA_DataPackage, VTG_Sample);
    // ZDA_Structure_Update(&GPS_NMEA_DataPackage, ZDA_Sample);
    NMEA_Structure_Update(&GPS_NMEA_DataPackage, ZDA_Sample);
